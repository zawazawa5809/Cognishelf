...
**Cognishelf** は、**Stable Diffusion用のプロンプト管理・最適化ツール**です。画像生成AIのプロンプトを効率的に保存・整理し、スタイルプリセットやバリエーション生成などの機能で生成ワークフローを劇的に改善します。
...
**主要用途:**
- Stable Diffusionプロンプトの保存・管理
- パラメータ(Steps, CFG, Sampler等)の記録
- スタイルプリセットのワンクリック適用
- バリエーション自動生成
- プロンプト最適化提案
...
### 今後の拡張(Stable Diffusion特化)

**Phase 0: Vite移行準備** (1週間)
- モダン開発環境構築
- モジュール分割

**Phase 1: SD特化基盤** (3日間)
- データモデル拡張(sdConfigフィールド追加)
- パラメータ保存機能

**Phase 2: プロンプトミキサー** (1週間)
- レイヤー型プロンプト組み立てUI
- チェックボックスで簡単組み合わせ

**Phase 3: スタイルプリセット** (3日間)
- 高品質プリセットライブラリ
- ワンクリック適用

**Phase 4: バリエーションジェネレーター** (1週間)
- テンプレート変数システム
- 一括バリエーション生成
